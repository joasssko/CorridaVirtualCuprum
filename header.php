...
<div id="aviso" class="hidden-lg hidden-md">
	<?php /* <img src="<?php echo get_bloginfo('template_directory')?>/images/logo.png" alt=""> */?>
    <div id="inside"><img src="<?php echo get_bloginfo('template_directory')?>/images/cuprum_mobile.png" alt="" /><span class="fa fa-mobile fa-rotate-90"></span>Para una mejor experiencia, gire su dispositivo a la posición horizontal.</div>
